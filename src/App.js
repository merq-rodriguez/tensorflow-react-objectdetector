...
function App() {
  ...
  const actionButton = {
    ...
    modelReady: { action: upload, text: "Subir imagenes" },
    imageReady: { action: identify, text: "Identificar objetos" },
    identifying: { text: "Identificando.." },
    complete: { action: reset, text: "Reiniciar" }
  };
  ...
  const renderTable = (array) => {
    return (
      <ul>
          {array.map(({ className, probability }) => (
  ...
  return (
    <div>
      {!showImage && <img src={require('./tensor.png')}  />}
